...
// Public suffixes where setting a parent domain is not allowed or unsafe
const PUBLIC_SUFFIXES = new Set(["railway.app", "vercel.app", "netlify.app", "herokuapp.com", "onrender.com", "fly.dev", "manus.space"]);
 ...
 * 
 * For public deployment platforms (railway.app, vercel.app, etc.),
 * we don't set a domain so the browser uses the exact hostname.
 */
function getParentDomain(hostname: string): string | undefined {
  ...
  // Check if this is a public deployment platform — don't set parent domain
